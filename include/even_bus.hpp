...
namespace skibidi
{
    // Datos que puede transportar un evento
    struct EventData
    {
        std::string type = "";
        std::string name = "";
    ...
    // Clase base para objetos que quieran escuchar eventos
    class EventListener
    {
    public:
    ...
    {
        // Cuando se destruye un listener,
        // se desuscribe automaticamente
